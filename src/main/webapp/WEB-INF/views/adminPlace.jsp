                    ...
                    <form:form action="/admin/adminPlace" method="POST" modelAttribute="place">
                        ...
                        <div class="form-group row">
                            <div class="col-8 mr-auto">
                                ...
                                <a href="/admin/adminPlace/cancel<custom:allParams/>"
                                        ...
                                        <div class="collapse" id="secondCollapse">
                                            <div class="card card-body">
                                                <c:forEach var="place" items="${placesString}">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <form:checkbox path="countOfPeople"
                                                                           value="${place}"/> ${place} people
                                                        </div>
                                                    </div>
                                                </c:forEach>
                                            </div>
                        ...
                        <c:forEach var="place" items="${places.content}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/adminPlace/update/${place.id}<custom:allParams/>"
