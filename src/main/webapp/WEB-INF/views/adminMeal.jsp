    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-sm-12">
            <div class="row">
                <div class="col-12">
                    <h3>Add new Meal</h3>
                    <form:form action="/admin/adminMeal" method="POST" modelAttribute="meal"
                               enctype="multipart/form-data">
                        <custom:hiddenInputs
                                excludeParams="name, fullDescription, shortDescription, price, weight, _csrf"/>
                        <div class="row">
                                        ...
                                        <div class="collapse" id="thirdCollapse">
                                            <div class="card card-body">
                                                <c:forEach var="component" items="${components}">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <form:checkbox path="componentsId"
                                                                           value="${component.id}"/> ${component.amount} ${component.ms} ${component.ingredient}
                                                        </div>
                                                    </div>
                                                </c:forEach>
                                            </div>
                        ...
                        <c:forEach var="meal" items="${meals.content}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/adminMeal/update/${meal.id}<custom:allParams/>"
                                       class="btn btn-outline-warning btn-sm margin">Update</a>
                                    <a href="/admin/adminMeal/delete/${meal.id}<custom:allParams/>"
                                       class="btn btn-outline-danger btn-sm margin">Delete</a>
                                </td>
                                <td class="text-center">
                                    <img src="${meal.photoUrl}?version=${meal.version}" style="width: 100px;" alt="meal image">
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
