                ...
                <div class="col-lg-3 col-sm-12 ml-auto">
                    <div class="row">
                        <div class="col-6 text-center">
                            <button class="dropdown-toggle btn btn-outline-success btn-sm" type="button"
                        ...
                        <c:forEach var="cuisine" items="${cuisines.content}">
                            <tr>
                                ...
                                <td class="text-center"><a
                                        href="/admin/adminCuisine/update/${cuisine.id}<custom:allParams/>"
                                        class="btn btn-outline-warning btn-sm">Update</a> <a
                                        href="/admin/adminCuisine/delete/${cuisine.id}<custom:allParams/>"
