                    ...
                    <form:form action="/admin/adminIngredient" method="POST" modelAttribute="ingredient">
                        ...
                        <div class="form-group row">
                            <div class="col-8 mr-auto">
                                ...
                                <a href="/admin/adminIngredient/cancel<custom:allParams/>"
                        ...
                        <c:forEach var="ingredient" items="${ingredients.content}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/adminIngredient/update/${ingredient.id}<custom:allParams/>"
                                       class="btn btn-outline-warning btn-sm margin">Update</a>
                                    <a href="/admin/adminIngredient/delete/${ingredient.id}<custom:allParams/>"
