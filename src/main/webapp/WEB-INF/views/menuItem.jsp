                            ...
                            <form:form action="/menuItem/${meal.id}" method="POST" modelAttribute="comment">
                                ...
                                <div class="star-rating">
                                    <div class="star-rating__wrap">
                                        <input class="star-rating__input fa" id="star-rating-5" type="radio" name="rate"
                                               value="5" title="5 out of 5 stars">
                                        <input class="star-rating__input fa" id="star-rating-4" type="radio" name="rate"
                                               value="4" title="4 out of 5 stars">
                                        <input class="star-rating__input fa" id="star-rating-3" type="radio" name="rate"
                                               value="3" title="3 out of 5 stars">
                                        <input class="star-rating__input fa" id="star-rating-2" type="radio" name="rate"
                                               value="2" title="2 out of 5 stars">
                                        <input class="star-rating__input fa" id="star-rating-1" type="radio" name="rate"
                                               value="1" title="1 out of 5 stars">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-8 mr-auto">
                                        ...
                                        <sec:authorize access="isAuthenticated()">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-warning"
                                                    onclick="location.href='/meal/${meal.id}<custom:allParams/>'">
                                                Cancel
                                            </button>
                                        </sec:authorize>
                                    </div>
        ...
        <div class="col-12">
            ...
            <c:forEach var="commentsOfmeal" items="${meal.comments}">
                <div class="comment">
                    <div class="row">
                        <div class="col-2">
                            <img src="${commentsOfmeal.user.photoUrl}?version=${commentsOfmeal.user.version}"
                                 style="width: 50px"> ${commentsOfmeal.user.email}
                        </div>
                        <div class="col-10">
                                ${commentsOfmeal.text}
                        </div>
