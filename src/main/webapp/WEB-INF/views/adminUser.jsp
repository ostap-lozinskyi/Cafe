                    ...
                    <form:form action="/admin/adminUser" method="POST" modelAttribute="user">
                        ...
                        <div class="form-group row">
                            <div class="col-8 mr-auto">
                                ...
                                <a href="/admin/adminUser/cancel<custom:allParams/>"
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="user" items="${users.content}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/adminUser/setDefaultPhoto/${user.id}<custom:allParams/>"
                                       class="btn btn-outline-warning btn-sm margin">Set default photo</a>
                                    <a href="/admin/adminUser/delete/${user.id}<custom:allParams/>"
                                       class="btn btn-outline-danger btn-sm margin">Delete</a>
                                    <br>
                                    <button class="btn btn-outline-success dropdown-toggle margin" type="button"
                                            id="dropdownMenuButton" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">Update Role
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item"
                                           href="/admin/adminUser/updateRole/${user.id}/ROLE_ADMIN<custom:allParams/>">Admin</a>
                                        <a class="dropdown-item"
                                           href="/admin/adminUser/updateRole/${user.id}/ROLE_CLIENT<custom:allParams/>">Client</a>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
