                    ...
                    <form:form action="/admin/adminMs" method="POST" modelAttribute="ms">
                        ...
                        <div class="form-group row">
                            <div class="col-8 mr-auto">
                                ...
                                <a href="/admin/adminMs/cancel<custom:allParams/>"
                ...
                <div class="col-12">
                    <table class="table table-bordered">
                        ...
                        <c:if test="${empty mss.content}">
                            <tr>
                                <td colspan=2><h3 class="text-center">Measuring Systems with such name not found</h3>
                                </td>
                            </tr>
                        </c:if>
                        <c:forEach var="ms" items="${mss.content}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/adminMs/update/${ms.id}<custom:allParams/>"
                                       class="btn btn-outline-warning btn-sm margin">Update</a>
                                    <a href="/admin/adminMs/delete/${ms.id}<custom:allParams/>"
