                    ...
                    <form:form action="/admin/adminComponent" method="POST" modelAttribute="component">
                        ...
                        <div class="form-group row">
                            <div class="col-8 mr-auto">
                                ...
                                <a href="/admin/adminComponent/cancel<custom:allParams/>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2 col-sm-4 margin">
                                        ...
                                        <div class="collapse" id="thirdCollapse">
                                            <div class="card card-body">
                                                <form:checkboxes items="${ingredients}" path="ingredientName"
                                                                 element="div"/>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <c:forEach var="component" items="${components.content}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/adminComponent/update/${component.id}<custom:allParams/>"
                                       class="btn btn-outline-warning btn-sm margin">Update</a>
                                    <a href="/admin/adminComponent/delete/${component.id}<custom:allParams/>"
